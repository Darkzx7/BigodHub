-- ══════════════════════════════════════════════════════════════════════════════
-- MM2 v20
-- Silent aim: arg[1]=origem (CFrame, NAO mexer), arg[2]=alvo (CFrame, substituir)
-- Skeleton ESP: LineHandleAdornment entre joints, AlwaysOnTop (wall), cor por papel
-- ══════════════════════════════════════════════════════════════════════════════
...
local ui = RefLib.new("mm2 v20", "rbxassetid://131165537896572", "ref_mm2v20")
...
local function flyTo(dest)
    ...
    local s = hrp.Position; local dist = (dest - s).Magnitude; if dist < 0.5 then return end
