...
-- CONFIGURAÇÃO DE PRECISÃO ORIGINAL COMPLETA
local PRECISION = {
    checkInterval = 0.016,
...
-- Atualizações de Status Aprimoradas
...
-- CONTROLE DO INDICADOR ORIGINAL COMPLETO - ESTA É A FUNÇÃO PRINCIPAL!
...
-- Execute
main()ButtonEvent(0, 0, 0, false, game, 0)
                        holdingClick = false
                    end
